...
public final class HealthySeverity implements ISeverity {
    private static final String KEY = "low";
    private static final int URGENCY = 0;
    private final ISeverityPhrase phrase;

    public HealthySeverity(ISeverityPhrase phrase) {
        this.phrase = Objects.requireNonNull(phrase, "healthy severity requires a phrase");
    }
