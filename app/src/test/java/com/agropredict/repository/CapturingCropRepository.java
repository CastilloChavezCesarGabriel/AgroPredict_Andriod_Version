...
public final class CapturingCropRepository implements ICropRepository {
    ...
    public void walk(ICropVisitor visitor) {
        for (Crop crop : stored) crop.accept(visitor);
    }
    ...
    @Override public void delete(String identifier) { deleted.add(identifier); }
}
